...
#define configTOTAL_HEAP_SIZE					((size_t)(8*1024))     //ϵͳ�����ܵĶѴ�С/*������Ĺ���ᵼ���ڴ治��˴�����Ϊ10K�������������Ҫ���л���--�����ĵ�����ע*/
...
/*                                FreeRTOS������ʱ�������״̬�ռ��йص�����ѡ��                                 */
/***************************************************************************************************************/
#define configGENERATE_RUN_TIME_STATS	        0                       //Ϊ1ʱ��������ʱ��ͳ�ƹ��ܣ�/*����Ŀû�õ�����˹ر�--�����ĵ�����ע*/
...
#else
	#define configPRIO_BITS       		4     /*��������MCUʹ�ü�λ���ȼ�,����FREERTOS��֧�������ȼ��Ĺ����������Ҫ��������Ϊ4--�����ĵ�����ע*/
#endif

#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY			15                      //�ж�������ȼ�
#define configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY	3                       //ϵͳ�ɹ���������ж����ȼ������ڴ����ȼ����жϣ�freertos�������Σ�Ҳ���ܵ���api--�����ĵ�����ע
